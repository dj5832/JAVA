...
public class ComparisonOperator {
	...
	public static void main(String[] args) {
		...
		// 1보다 2가 큰가?
		result = 1 < 2;
		System.out.println("1보다 2가 큰가? --> " + result);
		// 0은 100보다 작거나 같은가?
		result = 0 <= 100;
		System.out.println("0은 100보다 작거나 같은가? --> " + result);
		// 3.14f와 3.14는 다른가?
		result = 3.14f != 3.14;
		System.out.println("3.14f와 3.14는 다른가? --> " + result);
		// "남자"와 "여자"는 다른가?
		result = !"남자".equals("여자");
		System.out.println("\"남자\"와 \"여자\"는 다른가? --> " + result);
