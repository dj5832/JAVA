...
//		}
//		
//		if(a < 100)	System.out.println("조건식의 연산 결과가 true 이면 수행된다.");
//		
//		
//		if(a < 10) {
//			System.out.println("조건식의 연산 결과가 false 이면 수행되지 않는다.");
//		}
...
//		System.out.println("주민등번호 뒷자리 첫번째 숫자를 입력해주세요.");
...
//		Scanner s = new Scanner(System.in);
		// 값이 String 으로 들어오기 때문에 int 타입으로 형변환 해줘야 한다.
