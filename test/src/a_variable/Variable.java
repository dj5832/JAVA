...
public class Variable {
	...
	public static void main(String[] args) {
		 ...
		 *  - [여러 단어로 이러우진 경우에는 단어의 첫 글자를 대문자로 한다.(상수는 언더바로 구분)]
		 *  - [클래스명의 첫글자는 대문자로 한다.]
		 *  - [패키지명은 모두 소문자로 한다.]
		 */
		...
		_long = 40L;
		_float = 3.14f;
		_double = 3.14;		// double 은 접미사를 생략할 수 있다.
		_char = '가';		// char 타입의 문자는 ''으로 묶여진 것만 가능하다. ""은 String 타입.
		_boolean = true;
...
//======================================================================================
		...
		System.out.println("숫자를 입력해주세요.");
		int inputNum1 = Integer.parseInt(s.nextLine());
		System.out.println("입력받은 문자열 : " + inputNum1);
		System.out.println("숫자를 입력해주세요.");
		int inputNum2 = Integer.parseInt(s.nextLine());
		System.out.println("입력받은 문자열 : " + inputNum2);
		System.out.println("숫자를 입력해주세요.");
		int inputNum3 = Integer.parseInt(s.nextLine());
		System.out.println("입력받은 문자열 : " + inputNum3);
		
		int sum = inputNum1 + inputNum2 + inputNum3;
		System.out.println("3개를 합친 총 합은 : " + sum + " 입니다.");
//======================================================================================
